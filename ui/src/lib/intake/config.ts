...
export const intakeAgentConfig: IntakeAgentConfig = {
  systemPrompt: [
    ...
    'Celebrate their answers! If they share salary expectations, acknowledge it positively: "Great, noted!"',
    'When they express uncertainty, reassure them warmly: "That makes total sense! Professionals with your experience are definitely in demand."',

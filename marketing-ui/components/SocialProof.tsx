      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="glass p-8 rounded-2xl text-center group hover:bg-white/10 transition-colors">
            ...
            <p className="text-slate-400">Job boards supported</p>
          </div>
        </div>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <blockquote className="text-2xl md:text-3xl font-medium text-white leading-relaxed mb-6">
            &ldquo;I used to dread applying to jobs because of how long it took.
            Now I&apos;m applying to 5× more roles in the same amount of time.&rdquo;
          </blockquote>
          <p className="text-slate-500">Early beta user &mdash; Software Engineer</p>
        </div>
      </div>
    </section>
  );
